...
import { 
  ChevronLeft, ChevronRight, X, Download, Maximize2, Minimize2, 
  Settings2, Unlink, Package, Timer, Plug, Bot, BarChart3, Globe, 
  Building2, Plane, ClipboardList, Briefcase, Zap, CreditCard, 
  CircleDollarSign, Landmark, Wrench, Linkedin, TrendingUp, Users, 
  DollarSign, Target, Award, CheckCircle2, ArrowRight, Calendar,
  Rocket, Shield, Clock, Percent, PieChart, type LucideIcon 
} from "lucide-react";
...
const CoverSlide = () => (
  <div className="flex flex-col items-center justify-center h-full text-center p-8 md:p-12 bg-gradient-to-br from-background via-background to-accent/20">
    <div className="mb-4">
...
const VisionSlide = () => (
  <div className="p-8 md:p-12 h-full flex flex-col justify-center bg-gradient-to-br from-background to-accent/20 overflow-y-auto">
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        {[
          ...
          <div key={stat.label} className="text-center p-4 rounded-xl bg-card border border-border/50 shadow-sm">
      ...
      <div className="bg-card rounded-2xl border border-border/50 p-5 shadow-lg">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          {[
            ...
            <div key={item.year} className="flex items-center gap-3 flex-1">
              <div className="text-center flex-1">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full ${
                  item.status === "In Progress" ? "bg-emerald-500/10 text-emerald-600" :
...
const ProblemSlide = () => {
  ...
  return (
    <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
  ...
  return (
    <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
      ...
      <div className="grid md:grid-cols-3 gap-5 max-w-6xl mx-auto mb-6">
        {solutions.map(item => (
          <div key={item.title} className="rounded-xl p-5 text-center bg-gradient-to-br from-card via-accent/5 to-card border border-border/50 shadow-md">
      ...
      <div className="max-w-6xl mx-auto mt-5">
        <div className="flex flex-wrap justify-center gap-2">
          {["AWS", "Kubernetes", "PostgreSQL", "Redis", "GraphQL", "REST API"].map(tech => (
            <span key={tech} className="px-3 py-1 rounded-full bg-muted text-xs font-medium text-muted-foreground">
              {tech}
            </span>
          ))}
        </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div key={stat.label} className="text-center p-5 rounded-xl bg-primary/5 border border-primary/10 shadow-md">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div key={region.region} className="text-center p-4 rounded-xl bg-card border border-border/50 shadow-sm">
  ...
  <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 max-w-6xl mx-auto">
      ...
      <div className="space-y-3 flex-1 max-w-xl">
        {[
          ...
          <div key={product.name} className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border/50 shadow-sm hover:shadow-md transition-shadow">
            <div className={`w-3 h-3 rounded-full ${product.color} shadow`} />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-foreground">{product.name}</span>
                <span className={`text-xs px-2 py-0.5 rounded-full ${
                  product.status === "Live" ? "bg-emerald-500/10 text-emerald-600" : "bg-amber-500/10 text-amber-600"
                }`}>{product.status}</span>
              </div>
    ...
    <div className="mt-6 text-center">
      ...
      <div className="flex justify-center gap-4">
        {["Amadeus", "Sabre", "Travelport", "Mystifly", "TBO"].map(partner => (
          <span key={partner} className="px-3 py-1 rounded-full bg-muted text-xs font-medium text-muted-foreground">
            {partner}
          </span>
        ))}
      </div>
...
const TargetMarketSlide = () => {
  const markets: {
    ...
    { segment: "OTAs", desc: "Online Travel Agencies", size: "Primary", marketSize: "$8.2B", customers: "~2,500", Icon: Globe },
    { segment: "TMCs", desc: "Travel Management Companies", size: "Primary", marketSize: "$4.8B", customers: "~4,000", Icon: Building2 },
    { segment: "Airlines", desc: "Direct carriers", size: "Primary", marketSize: "$3.2B", customers: "~400", Icon: Plane },
    { segment: "Consolidators", desc: "Ticket consolidators", size: "Secondary", marketSize: "$2.1B", customers: "~1,200", Icon: ClipboardList },
    { segment: "Corporate Travel", desc: "Enterprise platforms", size: "Secondary", marketSize: "$1.8B", customers: "~800", Icon: Briefcase },
    { segment: "Travel Tech", desc: "White-label solutions", size: "Tertiary", marketSize: "$1.2B", customers: "~500", Icon: Zap },
  ];
  ...
  return (
    <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto mb-6">
        {markets.map(market => (
          <div key={market.segment} className="p-4 rounded-xl bg-gradient-to-br from-card via-accent/5 to-card border border-border/50 shadow-sm">
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        {[
          ...
          <div key={item.label} className="flex items-center gap-3 bg-card border border-border/50 rounded-lg p-4 shadow-sm">
    ...
    <div className="max-w-6xl mx-auto mt-6">
      ...
      <div className="grid grid-cols-5 gap-3">
        {[
          ...
          <div key={item.year} className="text-center p-3 rounded-lg bg-card border border-border/50 shadow-sm">
...
const RevenueModelSlide = () => {
  const models: {
    ...
    { title: "SaaS Subscriptions", desc: "Tiered monthly/annual pricing", revenue: "40%", Icon: CreditCard },
    { title: "Transaction Fees", desc: "Per-booking fee (€0.50-2.00)", revenue: "35%", Icon: CircleDollarSign },
    { title: "Enterprise Licensing", desc: "Custom implementations", revenue: "15%", Icon: Landmark },
    { title: "Implementation", desc: "Onboarding & support", revenue: "10%", Icon: Wrench },
  ];
  ...
  return (
    <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto mb-6">
        {models.map(model => (
          <div key={model.title} className="p-4 rounded-xl bg-gradient-to-br from-card via-accent/5 to-card border border-border/50 shadow-sm text-center">
      ...
      <div className="max-w-6xl mx-auto bg-card rounded-xl p-4 border border-border/50 shadow-sm mb-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          {[
            ...
            <div key={item.year} className="p-3 rounded-lg bg-muted/30">
      ...
      <div className="max-w-6xl mx-auto bg-card rounded-xl p-4 border border-border/50 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-center">
          {[
            { label: "CAC", value: "€2,400", note: "Customer Acquisition" },
            { label: "LTV", value: "€28,800", note: "Lifetime Value" },
            { label: "LTV:CAC", value: "12:1", note: "Ratio" },
            { label: "ARPU", value: "€800", note: "Per Month" },
            { label: "Payback", value: "3 mo", note: "Period" },
          ].map(item => (
            <div key={item.label}>
              <div className="text-lg font-bold text-primary">{item.value}</div>
...
const CompetitionSlide = () => (
  <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {/* Differentiators */}
      <div className="flex flex-wrap justify-center gap-2">
        {["Unified Platform", "AI-First", "Modern Stack", "Fair Pricing", "Fast Integration", "24/7 Support"].map(diff => (
          <span key={diff} className="px-3 py-1.5 rounded-full bg-gradient-to-r from-primary via-accent/40 to-primary border border-accent/50 text-xs font-medium shadow-sm text-primary-foreground">{diff}</span>
        ))}
      </div>
    </div>
  </div>
  ...
  <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {[
          { label: "Product Dev", amount: "€160K", percent: "40%", color: "bg-blue-500" },
          { label: "Sales & Mktg", amount: "€120K", percent: "30%", color: "bg-violet-500" },
          { label: "Operations", amount: "€80K", percent: "20%", color: "bg-emerald-500" },
          { label: "Team", amount: "€40K", percent: "10%", color: "bg-amber-500" },
        ].map(allocation => (
          <div key={allocation.label} className="text-center p-4 rounded-xl bg-card border border-border/50 shadow-sm">
      ...
      <div className="bg-card rounded-xl p-4 border border-border/50 shadow-sm mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center text-sm">
          {[
            ...
            <div key={item.month} className="p-2 rounded-lg bg-muted/30">
  ...
  <div className="p-8 md:p-12 h-full flex flex-col justify-center overflow-y-auto">
    ...
    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-6">
      {[
        ...
        <div key={member.name} className="text-center p-4 rounded-xl bg-card border border-border/50 shadow-sm">
          ...
          <div className="flex flex-wrap justify-center gap-1 mt-2">
            {member.skills.map(skill => (
              <span key={skill} className="px-2 py-0.5 rounded-full bg-muted text-xs text-muted-foreground">{skill}</span>
            ))}
          </div>
          <a 
            ...
            className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 rounded-full bg-[#0A66C2] hover:bg-[#004182] text-white text-xs font-medium transition-colors shadow-sm"
          >
    ...
    <div className="max-w-4xl mx-auto bg-card rounded-xl p-4 border border-border/50 shadow-sm mb-4">
      ...
      <div className="grid grid-cols-4 gap-2 text-center text-xs">
        {[
          ...
          <div key={hire.role} className="p-2 rounded-lg bg-muted/30">
            ...
            {slides.map((_, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === currentSlide ? "bg-primary w-6" : "bg-muted-foreground/30 hover:bg-muted-foreground/50 w-2"
                )}
              />
            ))}
          </div>
