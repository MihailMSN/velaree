...
// Slide 2: Vision
const VisionSlide = () => (
  <div className="p-12 md:p-16 h-full flex flex-col justify-center bg-gradient-to-br from-background to-accent/20">
    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid md:grid-cols-3 gap-8 mb-10">
        {[
          ...
          <div key={stat.label} className="text-center p-8 md:p-10 rounded-2xl bg-primary/5 border-2 border-primary/10 shadow-lg">
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 flex-1 max-w-xl">
        {[
          ...
          <div key={product.name} className="flex items-center gap-4 p-5 rounded-xl bg-card border border-border/50 shadow-md hover:shadow-lg transition-shadow">
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          <div key={allocation.label} className="text-center p-6 md:p-8 rounded-2xl bg-card border border-border/50 shadow-lg hover:shadow-xl transition-shadow">
...
>
        ...
        <div className="flex-1 relative overflow-hidden bg-background min-h-0">
          ...
          <Button
            ...
            size="icon"
            onClick={prevSlide}
            className="absolute left-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-card/90 backdrop-blur-sm border border-border/50 hover:bg-card shadow-xl"
          >
          ...
          <Button
            ...
            size="icon"
            onClick={nextSlide}
            className="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-card/90 backdrop-blur-sm border border-border/50 hover:bg-card shadow-xl"
          >
