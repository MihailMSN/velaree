...
const stats = [
  { label: "PNRs Monitored", value: "2,847", icon: Clock },
  { label: "Savings Found", value: "$42.3K", icon: TrendingDown },
  { label: "Re-booked Today", value: "156", icon: RefreshCw },
  { label: "Avg ROI", value: "18.4%", icon: DollarSign }
];
...
const ReShoppingMockup = () => {
  return (
    <MockupBrowser url="app.velaree.com/re-shopping">
      <div className="p-8">
        {/* Stats Grid */}
        <div className="grid grid-cols-4 gap-4 mb-6">
          {stats.map((stat, index) => {
            ...
            return (
              <Card 
                key={index}
                className="p-4 bg-card border-border animate-fade-in"
