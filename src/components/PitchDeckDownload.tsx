...
const PitchDeckDownload = () => {
  ...
  const generatePitchDeck = async () => {
    ...
    try {
      ...
      pdf.setFontSize(32);
      pdf.text("Unified APIs • AI Automation • Real-time Analytics", width / 2, height / 2 + 170, { align: "center" });
      ...
      pdf.setFontSize(22);
      pdf.setTextColor(textPrimary);
      pdf.text("Investor Presentation 2025", width / 2, height / 2 + 280, { align: "center" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Our Vision", width / 2, 200, { align: "center" });
      ...
      pdf.text(visionLines, width / 2, 350, { align: "center" });
      ...
      visionStats.forEach((stat, i) => {
        ...
        pdf.setTextColor(textPrimary);
        pdf.setFont("helvetica", "bold");
        pdf.text(stat.value, x, 680, { align: "center" });
        
        pdf.setFontSize(28);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(stat.label, x, 760, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Market Problem", width / 2, 200, { align: "center" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Our Solution", width / 2, 180, { align: "center" });
      
      pdf.setFontSize(32);
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("One unified platform for the entire travel technology stack", width / 2, 250, { align: "center" });
      ...
      solutions.forEach((solution, i) => {
        ...
        pdf.setFont("helvetica", "bold");
        pdf.text(solution.title, x + 250, 480, { align: "center" });
        
        pdf.setFontSize(26);
        pdf.setFont("helvetica", "normal");
        const lines = pdf.splitTextToSize(solution.desc, 420);
        pdf.text(lines, x + 250, 580, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Industry Demand", width / 2, 200, { align: "center" });
      ...
      demandStats.forEach((stat, i) => {
        ...
        pdf.setTextColor(textPrimary);
        pdf.setFont("helvetica", "bold");
        pdf.text(stat.value, x + 160, 460, { align: "center" });
        
        pdf.setFontSize(32);
        pdf.text(stat.label, x + 160, 560, { align: "center" });
        
        pdf.setFontSize(24);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(stat.sub, x + 160, 620, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Digital transformation is no longer optional — it's survival", width / 2, 845, { align: "center" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("How It Works", width / 2, 180, { align: "center" });
      
      pdf.setFontSize(32);
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("A complete product suite for every travel need", width / 2, 250, { align: "center" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Target Market", width / 2, 200, { align: "center" });
      ...
      markets.forEach((market, i) => {
        ...
        pdf.text(market.size, x + 100, y + 207, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Total Addressable Market", width / 2, 180, { align: "center" });
      ...
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("TAM", centerX, 300, { align: "center" });
      ...
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("SAM", centerX, 445, { align: "center" });
      ...
      pdf.setFontSize(20);
      pdf.text("SOM", centerX, centerY + 30, { align: "center" });
      ...
      labels.forEach((label, i) => {
        ...
        pdf.setTextColor(textPrimary);
        pdf.setFont("helvetica", "bold");
        pdf.text(label.title, x, 960, { align: "center" });
        pdf.setFontSize(22);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(label.desc, x, 1000, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Revenue Model", width / 2, 200, { align: "center" });
      ...
      revenueModels.forEach((model, i) => {
        ...
        pdf.setFontSize(48);
        pdf.text(model.revenue, x + 600, y + 30, { align: "right" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Go-to-Market Strategy", width / 2, 180, { align: "center" });
      ...
      phases.forEach((phase, i) => {
        ...
        pdf.setTextColor(255, 255, 255);
        pdf.setFont("helvetica", "bold");
        pdf.text(phase.phase, x + 110, 352, { align: "center" });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Competitive Landscape", width / 2, 180, { align: "center" });
      ...
      competitors.forEach((comp, i) => {
        ...
        pdf.setFont("helvetica", "bold");
        pdf.text(comp.title, x + 230, 360, { align: "center" });
        
        pdf.setFontSize(22);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(comp.sub, x + 230, 420, { align: "center" });
        
        pdf.setFontSize(22);
        pdf.setTextColor(comp.color[0], comp.color[1], comp.color[2]);
        pdf.setFont("helvetica", "bold");
        pdf.text(comp.verdict, x + 230, 560, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("Our Differentiators", width / 2, 750, { align: "center" });
      ...
      differentiators.forEach((diff, i) => {
        ...
        pdf.setTextColor(textPrimary);
        pdf.setFont("helvetica", "normal");
        pdf.text(diff, x + 90, y + 6, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("The Ask", width / 2, 180, { align: "center" });
      
      pdf.setFontSize(32);
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("Seed round to accelerate growth", width / 2, 240, { align: "center" });
      
      // Bigger number
      pdf.setFontSize(160);
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("€400,000", width / 2, 420, { align: "center" });
      
      pdf.setFontSize(32);
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("Pre-seed / Seed Investment", width / 2, 500, { align: "center" });
      ...
      allocations.forEach((alloc, i) => {
        ...
        pdf.setTextColor(255, 255, 255);
        pdf.setFont("helvetica", "bold");
        pdf.text(alloc.percent, x + 180, 673, { align: "center" });
        
        pdf.setFontSize(36);
        pdf.setTextColor(textPrimary);
        pdf.text(alloc.amount, x + 180, 790, { align: "center" });
        
        pdf.setFontSize(20);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(alloc.label, x + 180, 850, { align: "center" });
      });
      ...
      pdf.setTextColor(textPrimary);
      pdf.setFont("helvetica", "bold");
      pdf.text("The Team", width / 2, 200, { align: "center" });
      ...
      team.forEach((member, i) => {
        ...
        pdf.setTextColor(255, 255, 255);
        pdf.setFont("helvetica", "bold");
        pdf.text(member.role.charAt(0), x, 440, { align: "center" });
        
        pdf.setFontSize(40);
        pdf.setTextColor(textPrimary);
        pdf.text(member.role, x, 590, { align: "center" });
        
        pdf.setFontSize(24);
        pdf.setTextColor(textMuted);
        pdf.setFont("helvetica", "normal");
        pdf.text(member.focus, x, 650, { align: "center" });
      });
      ...
      pdf.setTextColor(textMuted);
      pdf.setFont("helvetica", "normal");
      pdf.text("velaree.com  •  contact@velaree.com", width / 2, 920, { align: "center" });
