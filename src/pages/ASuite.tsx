...
const ASuite = () => {
  ...
  const crmFeatures = ["360° customer view", "Communication history", "Booking patterns & preferences", "Loyalty program management", "Customer support ticketing", "Automated follow-ups"];
  const cmsFeatures = ["Drag-and-drop page builder", "Media library management", "SEO optimization tools", "Version control & rollback", "Multi-site management", "Template marketplace"];
  const operationsFeatures = ["Team collaboration tools", "Task management & workflows", "Document management", "Compliance tracking", "Audit logs & reporting", "Notification center"];
  const technicalSpecs = [{
    label: "Architecture",
    value: "Multi-tenant SaaS"
  }, {
    label: "Database",
    value: "PostgreSQL with Redis caching"
  }, {
    label: "Security",
    ...
    value: "Configurable (1-7 years)"
  }, {
    label: "API",
    value: "RESTful + GraphQL"
  }, {
    label: "Backup",
    value: "Automated daily + point-in-time recovery"
  }, {
    label: "Support",
    value: "24/7 with dedicated account manager"
  }];
  const pricingTiers = [{
    name: "Professional",
    price: "$999",
    ...
    features: ["Up to 10 users", "5,000 customers in CRM", "Basic white-label (logo, colors)", "Standard reports", "Email support", "Unified dashboard", "User management", "Booking management", "Basic analytics"],
    ...
    features: ["Up to 50 users", "25,000 customers in CRM", "Full white-label (custom domains)", "Custom reports & analytics", "API access", "Priority support", "Marketing automation", "Advanced workflows", "API monitoring"],
    cta: "Start Free Trial",
    popular: true
  }, {
    name: "Enterprise",
    ...
    features: ["Unlimited users", "Unlimited customers", "Multi-tenant architecture", "Advanced API access", "Custom integrations", "Dedicated account manager", "SLA guarantees", "On-premise option available", "Custom training"],
    cta: "Contact Sales",
    popular: false
  }];
  const useCases = [{
  ...
  return <>
      <Helmet>
        ...
        <meta name="description" content="Complete CRM/CMS platform for managing your travel technology stack. Customer management, content control, analytics, and white-label customization in one unified system." />
        <meta name="keywords" content="travel CRM, travel CMS, booking management, white label travel platform, travel agency software, OTA management, TMC software, travel analytics" />
