...
const RSTool = () => {
  return <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="AI-powered B2B air ticket re-shopping platform. Monitor PNRs 24/7, check pricing across all GDSs, and automatically find better fares. Save 5-15% post-sale." />
        ...
        <meta property="og:description" content="Monitor PNRs 24/7 and automatically find better fares across all GDSs. Save 5-15% on air tickets post-sale." />
        ...
        <meta name="twitter:description" content="Monitor PNRs 24/7 and automatically find better fares across all GDSs. Save 5-15% on air tickets post-sale." />
