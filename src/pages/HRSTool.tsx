...
const HRSTool = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Coming Soon Banner */}
      <div className="fixed top-[88px] md:top-[120px] left-0 right-0 z-40 bg-gradient-to-r from-orange-500/20 via-yellow-500/20 to-orange-500/20 border-b border-orange-500/30 backdrop-blur-sm">
